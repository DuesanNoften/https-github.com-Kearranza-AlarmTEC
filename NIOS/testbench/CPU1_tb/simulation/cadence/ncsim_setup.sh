...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPU1_mm_interconnect_0_router_014.sv"                        -work router_014                                   -cdslib ./cds_libs/router_014.cds.lib                                  
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_reset_source.sv"                               -work CPU1_inst_reset_bfm                          -cdslib ./cds_libs/CPU1_inst_reset_bfm.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_conduit_bfm.sv"                                       -work CPU1_inst_leds_bfm                           -cdslib ./cds_libs/CPU1_inst_leds_bfm.cds.lib                          
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_clock_source.sv"                               -work CPU1_inst_clk_bfm                            -cdslib ./cds_libs/CPU1_inst_clk_bfm.cds.lib                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/CPU1.v"                                                      -work CPU1_inst                                    -cdslib ./cds_libs/CPU1_inst.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/CPU1_tb.v"                                                                                                                                                                                        
fi
