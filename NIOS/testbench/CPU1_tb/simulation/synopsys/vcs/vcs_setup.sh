...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/CPU1_mm_interconnect_0_router_014.sv \
  ...
  $QSYS_SIMDIR/submodules/altera_conduit_bfm.sv \
  $QSYS_SIMDIR/submodules/altera_avalon_clock_source.sv \
  $QSYS_SIMDIR/submodules/CPU1.v \
  $QSYS_SIMDIR/CPU1_tb.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
